<template>  
  <div class="wrap">    
    <div class="sidebar">            
        ...
        <section class="sidebar_section">
          <h3 class="sidebar_section-title">Диапазон чисел:</h3>
          <form class="range">
            <div class="range_row">
              <label class="range_label" for="">От</label>
            ...
            <div class="range_row">
              <label class="range_label" for="">До</label>
              <input class="range_input"
              name="max"
              type="number" 
              inputmode="numeric" 
        ...
        <section class="sidebar_section" v-if="youResults.length > 0">
          <h3 class="result-title" @click="showModal = true">Ваши результаты</h3>           
        </section>       
    </div>
    <div class="content">
        ...
        <table class="table-results">
          ...
          <tbody>
            <tr v-for="(obj, ind) in youResults" :key="ind">
              <td v-for="value in obj" :key="value"><p>{{value}}</p></td>
            </tr>
          </tbody>
        </table>         
      </template>        
